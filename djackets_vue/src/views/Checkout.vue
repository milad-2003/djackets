...
export default {
    ...
    mounted() {
        ...
        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51QcC15BfOLOV7stNZlh4gvuMTPYdxfdLcLtkhRWVYV9cZdzLyzkmhZnLiQOgvSJAzQdoAbBC5aCtqYt8JdYmzdqW00pKP9rbR1')
            ...
            if (!this.errors.length) {
                ...
                this.stripe.createToken(this.card).then(result => {
                    if (result.error) {
                        ...
                        this.errors.push('Something went wronge with Stripe! Please try again.')
